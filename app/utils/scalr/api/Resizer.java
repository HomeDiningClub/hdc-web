 ...
 * <h3>Thread Safety</h3>
 * The {@link Resizer} class is <strong>thread-safe</strong> (as all the methods
...
public class Resizer {
    ...
    public static enum Method {
         ...
         * {@link Resizer#THRESHOLD_QUALITY_BALANCED} or
         * {@link Resizer#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
    ...
    public static enum Mode {
         ...
         *
         * See "Image Proportions" in the {@link Resizer} class description for
         * more detail.
         */
        AUTOMATIC,
        /**
    ...
    public static BufferedImage resize(BufferedImage src, Method scalingMethod,
        ...
        if (scalingMethod == Resizer.Method.AUTOMATIC)
        ...
        if (scalingMethod == Resizer.Method.SPEED) {
            result = scaleImage(src, targetWidth, targetHeight,
                    RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
        } else if (scalingMethod == Resizer.Method.BALANCED) {
            result = scaleImage(src, targetWidth, targetHeight,
                    RenderingHints.VALUE_INTERPOLATION_BILINEAR);
        } else if (scalingMethod == Resizer.Method.QUALITY
                || scalingMethod == Resizer.Method.ULTRA_QUALITY) {
			/*
     ...
     * {@link Resizer#DEBUG} is <code>true</code>; otherwise the VM will be
     ...
     *
     * @see Resizer#LOG_PREFIX
     * @see Resizer#LOG_PREFIX_PROPERTY_NAME
     */
    protected static void log(int depth, String message, Object... params) {
        if (Resizer.DEBUG) {
            System.out.print(Resizer.LOG_PREFIX);
     ...
     * method utilizes the {@link Resizer#THRESHOLD_QUALITY_BALANCED} and
     * {@link Resizer#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
    ...
    protected static Method determineScalingMethod(int targetWidth,
        ...
        if (length <= Resizer.THRESHOLD_QUALITY_BALANCED)
            result = Method.QUALITY;
        else if (length <= Resizer.THRESHOLD_BALANCED_SPEED)
