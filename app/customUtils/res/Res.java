...
public class Res {
    ...
    public static File get(String fileuid, String source, List<String> meta) {
        return Scala.orNull(customUtils.res.api.Res.get(fileuid, source, Scala.toSeq(meta)));
    }
    ...
    public static String put(File file, String source, String filename, String extension, List<String> meta) {
        return customUtils.res.api.Res.put(file, source, Scala.Option(filename), Scala.Option(extension), Scala.toSeq(meta));
    }
    ...
    public static String put(play.mvc.Http.MultipartFormData.FilePart filePart, String source, List<String> meta) {
        return customUtils.res.api.Res.put(filePart, source, Scala.toSeq(meta));
    }
    ...
    public static boolean delete(String fileuid, String source, List<String> meta) {
        return customUtils.res.api.Res.delete(fileuid, source, Scala.toSeq(meta));
    }
    ...
    public static File fileWithMeta(String filePath, List<String> meta) {
        return Scala.orNull(customUtils.res.api.Res.fileWithMeta(filePath, Scala.toSeq(meta)));
    }
}
