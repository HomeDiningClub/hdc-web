...
trait EventRepository extends GraphRepository[Event] {
  ...
  @Query("MATCH (uc:`UserCredential`)-[:`IN_PROFILE`]->(up:`UserProfile`)-[:`HOSTS_EVENTS`]-(e:`Event`) OPTIONAL MATCH (c:`County`)<-[:`LOCATION_AT`]-(up) OPTIONAL MATCH (up)-[:`MAIN_IMAGE`]-(userImage:`ContentFile`) OPTIONAL MATCH (e)-[:`MAIN_IMAGE`]-(mainImage:`ContentFile`) RETURN e.name as EventName, e.preAmble as EventPreAmble, e.mainBody as EventMainBody, e.objectId as EventObjectId, COLLECT(mainImage.storeId) as MainImage, COLLECT(userImage.storeId) as UserImage, e.price as EventPrice, up.profileLinkName as ProfileLinkName, e.eventLinkName as EventLinkName, c.name as CountyName")
  ...
  @Query("MATCH (uc:`UserCredential`)-[:`IN_PROFILE`]->(up:`UserProfile`)-[:`HOSTS_EVENTS`]-(e:`Event`), (up)-[:`TAGGED_ON`]->(tw:`TagWord`) WITH up,tw,uc,e OPTIONAL MATCH (c:`County`)<-[:`LOCATION_AT`]-(up) OPTIONAL MATCH (up)-[:`MAIN_IMAGE`]-(userImage:`ContentFile`) OPTIONAL MATCH (e)-[:`MAIN_IMAGE`]-(mainImage:`ContentFile`) WHERE tw.objectId = {tagWordId} RETURN e.name as EventName, e.preAmble as EventPreAmble, e.mainBody as EventMainBody, e.objectId as EventObjectId, COLLECT(mainImage.storeId) as MainImage, COLLECT(userImage.storeId) as UserImage, e.price as EventPrice, up.profileLinkName as ProfileLinkName, e.eventLinkName as EventLinkName, tw.tagName as TagName, c.name as CountyName")
  ...
  @Query("MATCH (uc:`UserCredential`)-[:`IN_PROFILE`]->(up:`UserProfile`)-[:`HOSTS_EVENTS`]-(e:`Event`), (c:`County`)<-[:`LOCATION_AT`]-(up) WITH up,c,uc,e OPTIONAL MATCH (up)-[:`MAIN_IMAGE`]-(userImage:`ContentFile`) OPTIONAL MATCH (e)-[:`MAIN_IMAGE`]-(mainImage:`ContentFile`) WHERE c.objectId = {countyId} RETURN e.name as EventName, e.preAmble as EventPreAmble, e.mainBody as EventMainBody, e.objectId as EventObjectId, COLLECT(mainImage.storeId) as MainImage, COLLECT(userImage.storeId) as UserImage, e.price as EventPrice, up.profileLinkName as ProfileLinkName, e.eventLinkName as EventLinkName, c.name as CountyName")
